...
allowed-tools: Bash, Read, mcp__docsbook__get_workspace, mcp__docsbook__list_workspaces, mcp__docsbook__get_negative_feedback, mcp__docsbook__get_ai_unanswered, mcp__docsbook__set_chat_system_prompt
argument-hint: [--workspace <id>]
---

# /docs-tune-ai-chat — tune the AI chat prompt from real failure signal
