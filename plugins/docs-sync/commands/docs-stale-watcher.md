...
allowed-tools: Bash, Read, Write, Edit, Glob, Grep, mcp__docsbook__get_workspace, mcp__docsbook__list_workspaces, mcp__docsbook__register_webhook_content_outdated
argument-hint: [--threshold-days 180]
---

# /docs-stale-watcher — turn stale-content alerts into GitHub Issues
