...
Shortcut for `/docs-analyze --only media`. See the underlying skill at [docs-media](https://github.com/Docsbook-io/docs-skills/blob/main/skills/docs-media/SKILL.md).
