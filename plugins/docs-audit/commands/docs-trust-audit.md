...
# /docs-trust-audit — quick shortcut

Shortcut for `/docs-analyze --only trust-audit`. See the underlying skill at [docs-trust-audit](https://github.com/Docsbook-io/docs-skills/blob/main/skills/docs-trust-audit/SKILL.md).
