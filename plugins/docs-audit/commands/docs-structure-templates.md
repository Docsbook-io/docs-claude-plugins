...
# /docs-structure-templates — quick shortcut

Shortcut for `/docs-analyze --only structure-templates`. See the underlying skill at [docs-structure-templates](https://github.com/Docsbook-io/docs-skills/blob/main/skills/docs-structure-templates/SKILL.md).
