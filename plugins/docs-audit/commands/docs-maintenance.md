...
# /docs-maintenance — quick shortcut

Shortcut for `/docs-analyze --only maintenance`. See the underlying skill at [docs-maintenance](https://github.com/Docsbook-io/docs-skills/blob/main/skills/docs-maintenance/SKILL.md).
