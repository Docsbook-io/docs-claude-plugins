...
# /docs-pricing-consistency — quick shortcut

Shortcut for `/docs-analyze --only pricing-consistency`. See the underlying skill at [docs-pricing-consistency](https://github.com/Docsbook-io/docs-skills/blob/main/skills/docs-pricing-consistency/SKILL.md).
