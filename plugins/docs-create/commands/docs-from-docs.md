...
# /docs-from-docs — import an existing docs platform into Markdown
...
- `{"status":"error","reason":"platform_unknown"}` → print `hint` verbatim. List the supported platforms. Suggest `/docs-from-code <repo>` for plain code repos.
