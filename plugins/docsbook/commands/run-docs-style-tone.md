...
# /docsbook:run-docs-style-tone — quick shortcut

Shortcut for `/docsbook:run-docs-analyze --only style-tone`. See the underlying skill at [docs-analyze — style-and-register detector](https://github.com/Docsbook-io/docs-skills/blob/main/skills/docs-analyze/references/detectors.md).
