...
allowed-tools: Bash, Read, Write, Edit, mcp__plugin_docsbook_docsbook__get_workspace, mcp__plugin_docsbook_docsbook__list_workspaces, mcp__plugin_docsbook_docsbook__update_languages, mcp__plugin_docsbook_docsbook__set_translation_mode, mcp__plugin_docsbook_docsbook__register_webhook_translation_completed
argument-hint: --languages es,fr,de [--slack-webhook <url>]
---

# /docsbook:run-docs-enable-translation — turn on AI auto-translation
