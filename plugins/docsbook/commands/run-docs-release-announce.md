...
allowed-tools: Bash, Read, Write, Edit, Glob, Grep, mcp__plugin_docsbook_docsbook__get_workspace, mcp__plugin_docsbook_docsbook__list_workspaces, mcp__plugin_docsbook_docsbook__register_webhook_content_indexed
argument-hint: --slack <url> | --email <address>
---

# /docsbook:run-docs-release-announce — announce releases to Slack and/or email
